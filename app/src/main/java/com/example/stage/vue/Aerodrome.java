...
public class Aerodrome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aerodrome);
    ...
    private void ecouteAffichage(){
        ...
        ((Button) findViewById(R.id.btnAffichage)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!annee.equals("")) {  //verifie si toute les valeurs sont ecrite
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {//Démarrer l'écriture et la lecture des données avec l'URL
                            ...
                            data[0] = annee;
                            PutData putData = new PutData("http://sc1chfl1498.universe.wf/Equ26K7z/LesAges/Aerodrome.php", "POST", field, data);
                ...
                RMS = String.valueOf(txtRMS.getText());
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {//Démarrer l'écriture et la lecture des données avec l'URL
                            ...
                            PutData putData = new PutData("http://sc1chfl1498.universe.wf/Equ26K7z/LesAges/envoieAerodrome.php", "POST", field, data);
