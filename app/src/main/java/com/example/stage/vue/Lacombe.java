                ...
                final String annee = SPAnnee(SPAnnee);
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {//Démarrer l'écriture et la lecture des données avec l'URL
                            ...
                            data[0] = annee;
                            PutData putData = new PutData("http://192.168.43.81/LesAges/Lacombe.php", "POST", field, data);
                ...
                RMS = String.valueOf(txtRMS.getText());
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {//Démarrer l'écriture et la lecture des données avec l'URL
                            ...
                            PutData putData = new PutData("http://192.168.43.81/LesAges/envoieLacombe.php", "POST", field, data);
