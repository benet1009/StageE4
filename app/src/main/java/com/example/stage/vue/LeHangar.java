...
public class LeHangar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_le_hangar);
                ...
                final String annee = SPAnnee(SPAnnee);
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {//Démarrer l'écriture et la lecture des données avec l'URL
                            ...
                            data[0] = annee;
                            PutData putData = new PutData("http://sc1chfl1498.universe.wf/Equ26K7z/LesAges/LeHangar.php", "POST", field, data);
                ...
                RMS = String.valueOf(txtRMS.getText());
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {//Démarrer l'écriture et la lecture des données avec l'URL
                            ...
                            PutData putData = new PutData("http://sc1chfl1498.universe.wf/Equ26K7z/LesAges/envoieHangar.php", "POST", field, data);
